...
const Home = () => {
  return (
    <section className="py-16 dark:text-navbar">
      {/*=========
        2. Hero
      ===========*/}
      <div className="text-center lg:px-6">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight max-w-5xl mx-auto">
          A Team Driven to Simplify Law{" "}
          <span className="dark:text-darkText">Through AI.</span>
        </h1>

        <p className="mt-6 text-lg md:text-xl max-w-3xl mx-auto dark:text-darkDesc">
      ...
      <div className="mt-24 max-w-6xl mx-auto text-center">
        ...
        <div className="flex justify-between items-center flex-col lg:flex-row gap-12 dark:text-darkDesc">
          <div className="w-full max-w-xl lg:text-left">
            ...
            <p className="mt-6 text-base md:text-lgleading-relaxed">
        ...
        <div className="mt-8">
          <a href="https://i-law.vercel.app/" target="_blank">
            <button className="px-8 py-3 rounded-xl bg-hover dark:bg-darkText text-white font-semibold transition flex items-center gap-2 mx-auto hover:bg-blue-700 dark:hover:bg-opacity-90">
