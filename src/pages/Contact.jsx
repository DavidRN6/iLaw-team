    ...
    <section className="py-16 lg:px-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl md:text-4xl font-bold leading-tight max-w-5xl mx-auto">
          Get in Touch with the iLaw Team
        </h1>
      ...
      {/*=================
        3. Contact Head
      ====================*/}
      <div className="max-w-2xl mx-auto bg-transparent p-8 rounded-2xl shadow-lg border border-border">
        <h3 className="text-xl font-bold mb-2 text-center">Contact the Team</h3>
        <p className="mb-6 text-center">For direct inquiries:</p>
        {/*==========
          4. Form
        =============*/}
